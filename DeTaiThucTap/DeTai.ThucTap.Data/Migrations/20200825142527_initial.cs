        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LearningGoalId = table.Column<Guid>(nullable: false),
                    VocabilaryId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LearningGoalDetails", x => new { x.LearningGoalId, x.VocabularyId })
                        .Annotation("SqlServer:Clustered", true);
                    table.ForeignKey(
                        name: "FK_LearningGoalDetails_LearningGoals_LearningGoalId",
