...
import {IHomeService} from './type';
import {VocabularyCategory, GroupCategory} from 'Providers/Models/type';
import {Sleep} from 'Commons';

class HomeService extends ServiceBase implements IHomeService {
